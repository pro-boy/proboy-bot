...
@borg.on(admin_cmd(pattern="selmon ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await event.edit("🚗🚗🚗\n🚘🚘🚘\n🚗🚗🚗\n🚘🚘🚘")
        await asyncio.sleep(1)
        await event.edit("🙁Selmon Bhoi Iz feeling Hungry😖 \nAlso he iz big fan of Bear Grills🤫😬")
        await asyncio.sleep(2.4)
        await event.edit("A Blackbuck iz spooted🦌 with {")
        await asyncio.sleep(1.9)
        await event.edit("😨Bhoi takes Out his Gun?🔫")
