...
async def _(event):
    ...
    sf = f"sf"
    cat = await event.edit("```Fox is on your way...```")
...
async def _(event):
    ...
    jisan = event.pattern_match.group(1)
    ttm = f"ttm"
    cat = await event.edit("```Wait making your hardcore meme...```")
    async with event.client.conversation("@themememakerbot") as conv:
        try:
            response = conv.wait_event(
                events.NewMessage(incoming=True, from_users=740813545)
...
async def _(event):
    ...
    jisan = event.pattern_match.group(1)
    bbs = f"bbs"
    cat = await event.edit("```You can't stop your brain...```")
    async with event.client.conversation("@themememakerbot") as conv:
        try:
            response = conv.wait_event(
                events.NewMessage(incoming=True, from_users=740813545)
...
async def _(event):
    ...
    jisan = event.pattern_match.group(1)
    sp = f"sp"
    cat = await event.edit("```Yaah wait for spongebob...```")
    async with event.client.conversation("@themememakerbot") as conv:
        try:
            response = conv.wait_event(
                events.NewMessage(incoming=True, from_users=740813545)
...
async def _(event):
    ...
    jisan = event.pattern_match.group(1)
    love = f"love"
    cat = await event.edit("```Wait for your son...```")
